<?php
    ...
    if(isset($_GET['apl_id'])){
        include '../../model/conectar.php';
        $apl_id = $_GET['apl_id'];
        $sql1 = "SELECT ap.apl_id, a.act_nombre, p.pel_nombre, ap.apl_papel  FROM actor_peliculas ap, actores a,  peliculas p
                WHERE ap.apl_id = ap.apl_id
                AND apl.act_id = a.act_id
                AND apl.pel_id = p.pel_id
                AND apl_id =".$apl_id;
